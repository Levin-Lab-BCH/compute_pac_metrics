function [] = plot_pac_strength(outcomes,save_dir,groups)
...
try
   ...
   % ylim([-0.75, 2.5]);
    ...
    saveas(fig,strcat(save_dir, filesep, 'Images', filesep, 'Freqband Strength Plots' ,filesep,polar_names{polar_name},'.pdf'));
    close(fig)
