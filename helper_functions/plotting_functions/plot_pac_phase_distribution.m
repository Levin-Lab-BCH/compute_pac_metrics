function [] = plot_pac_phase_distribution(outcomes,save_dir,colors)
...
for i =1:length(labels)
    ...
    errorbar((1:18)+0.1,g2_mean,g2_std,'Color',colors{1,2},'LineWidth',2)
    hold on
    errorbar((1:18)-0.1,g1_mean,g1_std,'Color',colors{1,1},'LineWidth',2)
    ylim([0.0544 0.0568]);
