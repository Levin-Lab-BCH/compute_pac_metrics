...
clear
[grp_proc_info_in] = function pac_analysis(grp_proc_info_in)
...
for sig_cluster_method = 1:2
    ...
    plot_clusters_with_boundaries(curr_sig_cluster.(groups{1,1}),MI_norm.(groups{1,1}),comodulogram_row_headers,comodulogram_column_headers,comodulogram_third_dim_headers,chan_labels,save_dir,groups{1,2})
    ...
    if grp_proc_info_in.pac_metrics.toggle_steps.run_all | grp_proc_info_in.pac_metrics.toggle_steps.run_phase_prop_analyses
        ...
        plot_phase_prop_and_stats(phase_prop_bins,phase_stats,groups,save_dir,alpha_deg);% Figure 5: Group differences of phase bias proportion in lf-hf pair coupling for overlap and non overlapped clusters. Not masked for significance
    end
end