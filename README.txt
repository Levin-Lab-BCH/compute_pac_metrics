...
1. a .csv "outputs" sheet which has a column named "Participants" and a column names "Group_Num" with the corresponding diagnosis for each participant
mapping to either 1 or 2