...
grp_proc_info.pac_metrics.path_struct.code_path = 'Z:\Public\EEG Analyses + Matlab scripts\PAC\Analyze_beapp_PAC_outputs'; %path to your "Analyze_beapp_PAC_outputs" folder, ex: '/Volumes/neuro-levin/Public/EEG Analyses + Matlab scripts/PAC/Analyze_beapp_PAC_outputs';
